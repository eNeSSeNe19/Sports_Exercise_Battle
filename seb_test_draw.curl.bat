...
curl -X POST http://localhost:10001/history --header "Content-Type: application/json" --header "Authorization: Basic kienboec-sebToken" -d "{\"Username\": \"kienboec\",  \"Count\": 50, \"DurationInSeconds\": 60}"
echo.
...
echo.
curl -X POST http://localhost:10001/history --header "Content-Type: application/json" --header "Authorization: Basic altenhof-sebToken" -d "{\"Username\": \"altenhof\",  \"Count\": 11, \"DurationInSeconds\": 25}"
echo.
echo.
