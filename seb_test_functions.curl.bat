...
echo.
curl -X POST http://localhost:10001/users --header "Content-Type: application/json" -d "{\"Username\":\"ahmed\", \"Password\":\"basdogan\"}"
echo.
...
echo.
curl -X POST http://localhost:10001/sessions --header "Content-Type: application/json" -d "{\"Username\":\"ahmed\", \"Password\":\"basdogan\"}"
echo.
...
echo.
curl -X GET http://localhost:10001/users/altenhof --header "Authorization: Basic ahmed-sebToken"
echo.
...
echo.
curl -X PUT http://localhost:10001/users/altenhof --header "Content-Type: application/json" --header "Authorization: Basic altenhof-sebToken" -d "{\"Name\": \"Ahmed\", \"Bio\": \"me studyin...\",  \"Image\": \":-O\"}"
echo.
echo.
curl -X GET http://localhost:10001/users/kienboec --header "Authorization: Basic kienboec-sebToken"
echo.
...
echo.
curl -X GET http://localhost:10001/stats --header "Authorization: Basic ahmed-sebToken" 
echo.
echo.
...
echo.
curl -X GET http://localhost:10001/history --header "Authorization: Basic ahmed-sebToken"
echo.
echo.
...
echo.
curl -X POST http://localhost:10001/history --header "Content-Type: application/json" --header "Authorization: Basic ahmed-sebToken" -d "{\"Username\": \"ahmed\",  \"Count\": 80, \"DurationInSeconds\": 90}"
echo.
echo.
...
curl -X GET http://localhost:10001/score --header "Authorization: Basic ahmed-sebToken"
echo.
echo.
...
echo.
curl -X POST http://localhost:10001/history --header "Content-Type: application/json" --header "Authorization: Basic ahmed-sebToken" -d "{\"Username\": \"ahmed\",  \"Count\": 5, \"DurationInSeconds\": 5}"
echo.
echo.

REM --------------------------------------------------
echo 14) list current tournament info/state 
curl -X GET http://localhost:10001/tournament --header "Authorization: Basic ahmed-sebToken"
echo.
